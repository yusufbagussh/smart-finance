...
<head>
    ...
    {{-- 1. Branding Title Standar Artafis --}}
...
<body class="font-sans antialiased bg-gray-50 dark:bg-gray-900">
    ...
    @else
                ...
                <div class="bg-purple-600 dark:bg-purple-800">
                    <div class="grid grid-cols-5 h-16">
                        ...
                        <a href="{{ route('admin.monitoring.index') }}"
                            ...
                            <i class="fas fa-heartbeat text-lg mb-0.5"></i>
        ...
        @else
            {{-- Mode User View untuk Akun Admin (7 Kolom Presisi) --}}
            <div
                class="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 md:hidden z-50 pb-safe">
                <div class="grid grid-cols-7 h-16 relative">
                    <a href="{{ route('dashboard') }}"
    ...
    <script>
        // SweetAlert2 Theme-Adaptive Loader
            ...
            if (
                ...
                if (link.hostname === window.location.hostname) {
                    ...
                    if (path.includes('dashboard') || linkText.toLowerCase() === 'home') {
                        ...
                        showSweetLoader('Katalog Aset', 'Memuat daftar aset pasar modal', 'fas fa-gem',
                            'text-indigo-400');
        ...
        // 2. Deteksi Submit Form (Kecuali form yang dicegat SweetAlert confirm)
        document.addEventListener('submit', function(e) {
            if (e.target.classList.contains('no-loader') || e.target.classList.contains('delete-form') || e.target
                .classList.contains('delete-user-form') || e.target.classList.contains('toggle-status-form')) {
                return;
            }
            ...
            if (action.includes('logout') || btnText.includes('logout') || btnText.includes('keluar')) {
                ...
                showSweetLoader('Menyimpan Data', 'Sedang memproses perubahan...', 'fas fa-save',
                    'text-emerald-400');
            }
        });

        // 3. Reset loader saat halaman selesai di-render / Back navigation
        window.addEventListener('pageshow', function() {
            hideSweetLoader();
        });

        // 4. Axios AJAX Interceptors
        if (window.axios) {
