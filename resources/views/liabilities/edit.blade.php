    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('liabilities.update', $liability) }}" class="p-6 sm:p-8 space-y-6">
                    @csrf
                    @method('PUT') {{-- PENTING: Untuk mengirim request UPDATE --}}
                    ...
                    <div
                        class="grid grid-cols-1 md:grid-cols-2 gap-4 border-b border-gray-200 dark:border-gray-700 pb-4">
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
                            <p class="text-xs font-medium text-gray-500 dark:text-gray-400">Original Amount</p>
                            <p class="text-xl font-bold text-gray-900 dark:text-gray-100">
                                Rp {{ number_format($liability->original_amount, 0, ',', '.') }}
                            </p>
                        </div>
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
                            <p class="text-xs font-medium text-red-600 dark:text-red-400">Current Balance</p>
                            <p class="text-xl font-bold text-red-600 dark:text-red-300">
                                Rp {{ number_format($liability->current_balance, 0, ',', '.') }}
                            </p>
                            <p class="text-xs text-gray-500 dark:text-gray-400">
                                Saldo hanya berubah melalui pembayaran cicilan.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="name" id="name"
                                value="{{ old('name', $liability->name) }}" required
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="number" name="tenor_months" id="tenor_months"
                                value="{{ old('tenor_months', $liability->tenor_months) }}" min="1"
                        ...
                        <div>
                            ...
                            <input type="number" name="interest_rate" id="interest_rate"
                                value="{{ old('interest_rate', $liability->interest_rate) }}" step="0.01"
                                min="0"
                    ...
                    <div
                        ...
                        <button type="submit"
                            ...
                            <i class="fas fa-save mr-2"></i> Update Loan Details
                        </button>
                    </div>
                </form>
            </div>
