    ...
    <x-slot name="header">
        <div class="flex items-center">
            ...
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                {{ __('Edit Investment Transaction') }}
            </h2>
        </div>
    </x-slot>
        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 sm:p-8">
                    ...
                    {{-- PERUBAHAN 2 & 4: Form Action dan Alpine x-data --}}
                    <form method="POST" action="{{ route('investment-transactions.update', $investmentTransaction) }}"
                        x-data="{ transactionType: '{{ old('transaction_type', $investmentTransaction->transaction_type) }}' }">
                        @csrf
                        {{-- PERUBAHAN 3: Method Spoofing --}}
                        @method('PUT')
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <select name="portfolio_id" id="portfolio_id" required
                                    ...
                                    @foreach ($portfolios as $portfolio)
                                        {{-- PERUBAHAN 5: portfolio_id --}}
                                        <option value="{{ $portfolio->id }}"
                                            {{ old('portfolio_id', $investmentTransaction->portfolio_id) == $portfolio->id ? 'selected' : '' }}>
                                            {{ $portfolio->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input type="text" name="transaction_date" id="transaction_date"
                                    ...
                                    value="{{ old('transaction_date', $investmentTransaction->transaction_date->format('Y-m-d')) }}"
                                    required>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    {{-- PERUBAHAN 5: quantity --}}
                                    <input type="number" name="quantity" id="quantity"
                                        value="{{ old('quantity', $investmentTransaction->quantity) }}"
