                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-4 items-end">
                        ...
                        <div class="sm:col-span-2 lg:col-span-5">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="search" id="search" value="{{ request('search') }}"
                                    class="pl-10 block w-full py-2 px-3 shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 rounded-md dark:bg-gray-700 dark:text-gray-200 focus:ring-indigo-500 focus:border-indigo-500"
                                    placeholder="BCA, OVO, Cash...">
                            </div>
                        </div>

                        {{-- Account Type (4 Kolom) --}}
                        <div class="lg:col-span-4">
                            ...
                            <select name="type" id="type"
                                class="block w-full py-2 px-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:text-gray-200">
                                <option value="">All Types</option>
                                <option value="cash" {{ request('type') === 'cash' ? 'selected' : '' }}>Cash</option>
                                <option value="bank_account" {{ request('type') === 'bank_account' ? 'selected' : '' }}>
                                    Bank Account</option>
                                <option value="e_wallet" {{ request('type') === 'e_wallet' ? 'selected' : '' }}>E-Wallet
                                </option>
                        ...
                        <div class="sm:col-span-2 lg:col-span-3 flex items-center justify-end space-x-2 pb-0.5">
                            <button type="submit"
                                class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 focus:bg-indigo-700 transition-colors">
                                <i class="fas fa-filter mr-2"></i>
                                Apply Filter
                            </button>
                            <a href="{{ route('accounts.index') }}"
                                class="inline-flex items-center px-4 py-2 bg-gray-300 dark:bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-gray-700 dark:text-gray-200 uppercase tracking-widest hover:bg-gray-400 dark:hover:bg-gray-500 transition-colors">
        ...
        <div class="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            @empty
                <div class="p-12 text-center">
                    ...
                    <p class="mt-1 text-gray-500 dark:text-gray-400">Try adjusting your filters or add a new account.
                    </p>
                </div>
            @endforelse
        </div>
